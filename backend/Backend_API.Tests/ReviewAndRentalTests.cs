...
namespace Backend_API.Tests
{
    ...
    public class ReviewAndRentalTests
    {
        ...
        public async Task CreateReview_WithRenterStatus_ShouldSucceed()
        {
            ...
            var rental1 = await context.Rentals.FirstAsync(r => r.TenantId == tenant.UserId && r.ListingId == listing.ListingId);
            rental1.Status = "ended";
            await context.SaveChangesAsync();
        ...
        public async Task SoftDeleteReview_ShouldSucceedWhenReplied()
        {
            ...
            var rental2 = await context.Rentals.FirstAsync(r => r.TenantId == tenant.UserId && r.ListingId == listing.ListingId);
            rental2.Status = "ended";
            await context.SaveChangesAsync();
        ...
        public async Task ReportReview_ShouldHideAfterThreshold()
        {
            ...
            var rental3 = await context.Rentals.FirstAsync(r => r.TenantId == tenant.UserId && r.ListingId == listing.ListingId);
            rental3.Status = "ended";
            await context.SaveChangesAsync();
