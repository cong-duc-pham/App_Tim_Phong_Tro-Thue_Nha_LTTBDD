...
class _ListingDetailScreenState extends State<ListingDetailScreen> {
            ...
            SliverToBoxAdapter(
              child: Column(
                ...
                children: [
                  ...
                  _buildReviewsSection(listing, state),
      ...
      actions: [
        ...
        CircleAvatar(
          ...
          child: IconButton(
            ...
            onPressed: () {
              context.read<ListingDetailBloc>().add(ToggleListingFavorite(listing.listingId));
            },
          ),
        ),
                    ...
                    itemBuilder: (context, index) {
                      return CachedNetworkImage(
                        ...
                        errorWidget: (context, url, error) => Container(
                          color: AppColors.illus1,
                          alignment: Alignment.center,
                          child: const Text('⚠️ Lỗi tải ảnh', style: TextStyle(color: AppColors.textSecondary)),
                        ),
                      );
                    },
                  ),
        ...
        children: [
            ...
            children: [
              ...
              if (listing.isVerified) ...[
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      Icon(Icons.verified_rounded, size: 10, color: AppColors.success),
                      SizedBox(width: 2),
                      Text(
                        'ĐÃ XÁC THỰC',
                        style: TextStyle(
          ...
          Row(
            ...
            children: [
              ...
              const Spacer(),
              const Icon(Icons.square_foot_rounded, size: 16, color: AppColors.textSecondary),
      ...
      child: Row(
        ...
        children: [
          ...
          _buildQuickStatItem(
            ...
            value: state.averageRating > 0 ? state.averageRating.toStringAsFixed(1) : 'Chưa có',
            label: state.reviewCount > 0 ? '${state.reviewCount} đánh giá' : 'Đánh giá',
          ),
        ],
      ),
    );
          ...
          GridView.count(
            ...
            children: [
              _buildUtilityItem(
                ...
                iconColor: AppColors.warning,
                label: 'Giá điện',
                value: listing.electricPrice != null ? '${_formatPrice(listing.electricPrice!)}/kWh' : 'Theo EVN',
              ),
              _buildUtilityItem(
                icon: Icons.water_drop_rounded,
                iconColor: AppColors.info,
                label: 'Giá nước',
                value: listing.waterPrice != null ? '${_formatPrice(listing.waterPrice!)}/khối' : 'Theo UBND',
              ),
              _buildUtilityItem(
                icon: Icons.wifi_rounded,
                iconColor: AppColors.primary,
                label: 'Internet',
                value: listing.internetPrice != null && listing.internetPrice! > 0
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 14),
          _buildInfoRow(Icons.layers_rounded, 'Tầng số', listing.floor != null ? '${listing.floor}/${listing.totalFloors ?? "?"}' : 'Chưa cập nhật'),
          _buildInfoRow(Icons.people_alt_rounded, 'Số người ở tối đa', listing.maxOccupants != null ? '${listing.maxOccupants} người' : 'Không giới hạn'),
          _buildInfoRow(Icons.pets_rounded, 'Cho phép nuôi thú cưng', listing.allowPet ? 'Có' : 'Không'),
          _buildInfoRow(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          Text(value, style: const TextStyle(fontSize: 13, color: AppColors.textPrimary, fontWeight: FontWeight.w700)),
        ],
      ),
    );
  }
  ...
  Widget _buildDescriptionSection(Listing listing) {
    final desc = listing.description?.trim() ?? 'Không có mô tả chi tiết cho phòng trọ này.';
          ...
          Row(
            children: [
              CircleAvatar(
                ...
                backgroundImage: avatar != null && avatar.trim().isNotEmpty ? CachedNetworkImageProvider(avatar) : null,
  ...
  Widget _buildReviewsSection(Listing listing, ListingDetailLoaded state) {
    return Container(
      margin: const EdgeInsets.only(top: 8),
      color: Colors.white,
      padding: const EdgeInsets.all(AppConstants.paddingH),
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text('Đánh giá phòng (${state.reviewCount})', style: AppTextStyles.h3),
              const Spacer(),
              ...
              Center(
                child: TextButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Tính năng hiển thị tất cả đánh giá đang được bổ sung'),
                        behavior: SnackBarBehavior.floating,
                      ),
                    );
                  },
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              CircleAvatar(
                radius: 16,
                backgroundColor: AppColors.bgPage,
                backgroundImage: review.reviewerAvatar != null && review.reviewerAvatar!.trim().isNotEmpty
                    ? CachedNetworkImageProvider(review.reviewerAvatar!)
                    : null,
                child: review.reviewerAvatar == null || review.reviewerAvatar!.trim().isEmpty
                    ? Text(
              ...
              RatingBarIndicator(
                ...
                itemBuilder: (context, index) => const Icon(Icons.star_rounded, color: AppColors.warning),
                itemCount: 5,
                itemSize: 13,
              ),
            ],
          ...
          if (review.replyContent != null && review.replyContent!.trim().isNotEmpty) ...[
            const SizedBox(height: 8),
            Container(
  ...
  Widget _buildBottomActionBar(BuildContext context, ListingDetailLoaded state) {
    final listing = state.listing;
              ...
              child: OutlinedButton.icon(
                ...
                icon: state.isFavoriteLoading
                    ...
                    : Icon(
                        ...
                        color: state.isFavorite ? AppColors.error : AppColors.textSecondary,
                        size: 20,
                      ),
                label: Text(
                ...
                style: OutlinedButton.styleFrom(
                  ...
                  side: BorderSide(color: state.isFavorite ? AppColors.error.withValues(alpha: 0.5) : AppColors.border),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    context.read<ListingDetailBloc>().add(LoadListingDetail(widget.listingId));
                  },
